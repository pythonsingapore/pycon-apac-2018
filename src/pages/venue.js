  ...
  <div className="container">
    ...
    <ContentCard>
      ...
      <p>
        ...
        has facilities to allow it to cater for up to about 15,000 students, as
        well as residents of the community. It was designed jointly by
      ...
      <p>
        ...
        <ul>
          <li>
            ...
            so coins or smaller notes will be more handy. It's more convenient
            to use an EZlink card. If you leave near a bus stop, you can check
            the arrival of the buses through these apps:{" "}
